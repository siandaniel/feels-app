...
return <View style={hidden ? styles.hidden : styles.container}>
    <FormInput  label='Registration number' placeholder="regnumber..." onChange={setRegNumber}/>
    <FormInput label="Password" placeholder="password" secure onChange={setPassword}/>
<LoginPressable text='Log in' onPress={() => console.log(regNumber, password)} isPrimary/>
        </View>
}
